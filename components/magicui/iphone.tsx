...
/**
 * Magic UI — iPhone mockup
 * Source: https://magicui.design/docs/components/iphone
 * Adapted to accept `children` rendered inside the screen area, so we can
 * embed any interactive content (like a scrollable carousel).
 */
    ...
    >
      ...
      {!hasVideo && src && (
        ...
        >
          ...
          <img
            src={src}
            alt="Preview do carrossel no iPhone"
            className="block size-full object-cover object-top"
          />
        </div>
      )}

      {/* Custom content slot — children rendered inside screen area, interactive */}
      ...
      >
        ...
        <path
          ...
          className="fill-transparent stroke-[#E5E5E5] stroke-[0.5] dark:stroke-[#404040]"
