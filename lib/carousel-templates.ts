...
> = {
  ...
  "madureira-reflection": {
    blocks: 7,
    rules: [
      "Texto corrido em parágrafos curtos (1-3 linhas). Sem listas, sem bullets, sem números no corpo (a menos que use payloads especiais `CURVE:`, `BARS:` ou `LIST:` no body). Capa = título Fraunces italic + emoji opcional. Demais slides = reflexão longa Geist sans, com **palavras-chave em ênfase** (vão renderizar como Fraunces italic accent). Última peça é CTA também em texto corrido com palavra-chave de ManyChat em **bold**. Voz: direta, sem travessão, pronome 'você' dominante.",
      "",
      "LAYOUTS DISPONÍVEIS NESSE TEMPLATE — use heuristics no body pra acionar:",
      "",
      "1. CoverEmoji (default pra variant=cover): heading começa com emoji + título Fraunces italic. Ex: heading=\"🧠 26 regras pra vender baseadas em psicologia\"",
      "",
      "2. CoverType (variant=cover sem emoji): heading sem emoji, opcional eyebrow/sub. Use prefixes:",
      "   - body começa com \"EYEBROW: <texto curto uppercase>\" → eyebrow mono no topo",
      "   - linha \"SUB: <texto>\" depois → sub em Geist 32px abaixo do título",
      "   Ex: heading=\"Reels estão mortos.\"  body=\"EYEBROW: CARROSSEL 31 · MAIO\\nSUB: A vez agora é do carrossel. E ninguém te avisou.\"",
      "",
      "3. Curve (gráfico 1%): body começa com \"CURVE:\" — opcional 1ª linha = data label.",
      "   Ex: heading=\"A matemática da consistência\" body=\"CURVE:\\n1.01^365 = 37,78 · 0.99^365 = 0,03\"",
      "",
      "4. Bars (barras semanais): body começa com \"BARS:\" + linhas tipo \"SEG 100\", \"TER 80\", etc. (SEG, TER, QUA, QUI, SEX, SAB, DOM)",
      "   Ex: heading=\"Isso é disciplina…\" body=\"BARS:\\nSEG 100\\nTER 80\\nQUA 5\\nQUI 20\\nSEX 70\\nSAB 90\\nDOM 10\"",
      "",
      "5. BulletsSoft: body com 3+ linhas começando com \"- \" ou \"• \" (≥60% das linhas). Listas italic suaves.",
      "",
      "6. BulletsExtreme (LIST mode): body começa com \"LIST:\" + linhas viram itens numerados. Ex: body=\"LIST:\\nFrequência fortalece marca\\nNutrição atrai audiência certa\\n...\"",
      "",
      "7. Reflection (fallback): qualquer outro variant. Parágrafos densos Geist sans 38px. Use **bold** pra ênfase — vira Fraunces italic accent vermilion automaticamente.",
      "",
      "8. CTA (variant=cta): obrigatório no último slide. Use **KEYWORD** no body — vira \"→ KEYWORD\" em accent. Ex: body=\"Manda **EU QUERO** que eu te mando o guia completo.\"",
      "",
      "REGRA HARD: ao escolher um carrossel ideal pra \"madureira-reflection\", distribua os 7-10 slides usando 4-6 layouts DIFERENTES (não use só Reflection). Capa = CoverEmoji ou CoverType. Pelo menos 1 Curve OU Bars OU BulletsExtreme no meio se o tema permitir matemática/comparação. Penúltimo = BulletsSoft com resumo. Último = CTA.",
      "",
