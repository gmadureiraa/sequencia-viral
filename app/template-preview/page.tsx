...
/**
 * Public preview — renderiza todos os templates lado a lado com dados mock
 * pra validar visualmente sem ir pelo fluxo completo de geração (Stripe,
 * Gemini, Imagen). Cada template aparece com 3 slides: cover, headline, cta.
 *
 * Uso: `bun dev` → http://localhost:3000/template-preview
 *
 * Rota fora de /app pra escapar do auth gate em proxy.ts. Só serve pra
 * dev — pode ser deletada quando os templates estiverem validados.
 */
  ...
  return (
    <div style={{ padding: 32, fontFamily: "system-ui, sans-serif", background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ marginBottom: 16, color: "#000" }}>
        <strong>Template selecionado:</strong> {selected}
      </div>
